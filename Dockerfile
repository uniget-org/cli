...
FROM ghcr.io/uniget-org/tools/gh:2.68.0@sha256:ca4b14433697b990cf0d10943e854de8024a35b3e2838804a1dfcf50421083dd AS uniget-gh
...
FROM ghcr.io/uniget-org/images/systemd:ubuntu24.04@sha256:014b0c6aee6dd38b7ce63172389608aa9d90e49a99d9da5ffe0fc2de26987dec AS systemd-uniget
ARG version
ARG TARGETARCH
RUN <<EOF
case "${TARGETARCH}" in
