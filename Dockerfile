...
FROM ghcr.io/uniget-org/tools/goreleaser:2.18.1@sha256:c87c583bbbd53369f5092cd9878bbc83345dcca2a96ffd84b196117437f0ad34 AS uniget-goreleaser
...
FROM ghcr.io/uniget-org/tools/syft:1.51.1@sha256:b908ba388c775e6b60ffbfe6c4050162744ebc1de98d1c86304a5b59b44a047d AS uniget-syft
FROM ghcr.io/uniget-org/tools/gh:2.101.0@sha256:bba1cb81eddc580325f36b9784f131ed0d3ee56714404416e96f22888245da4a AS uniget-gh
FROM ghcr.io/uniget-org/tools/glab:1.118.0@sha256:9ea9e52528d3714248bd425294bcfd048605fbe95af063b66a40550e54b062f3 AS uniget-glab
...
FROM ghcr.io/uniget-org/tools/golangci-lint:2.13.2@sha256:1118ad6d9ee37202ede6dfc1ccc4eca5c925e8191f1196f555ccd4941d053e32 AS lint-base
FROM golang:1.27.1@sha256:f44f6e88636cfb311f9ebace870ded69d943f227bb3cb27d32ffd84ea18c43ea AS latest-golang
FROM alpine:3.24.2@sha256:31b6477333eb8257db9e5d7c3a7264fd0467928756f0bbcc27d35bea5d28cdbd AS latest-alpine
FROM ubuntu:26.04@sha256:513c074113a871b51a8d16ab445c88779d6452d937a164fb5cc479f32668a41d AS latest-ubuntu2604
