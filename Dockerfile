...
FROM --platform=${BUILDPLATFORM} golang:1.22.2@sha256:b994e2c814955c73b9f93df71fde626a5c8aade26eb0de6e721a92d59eed5b3a AS base
WORKDIR /src
ENV CGO_ENABLED=0
COPY go.* .
...
FROM golangci/golangci-lint:v1.57.2@sha256:8f3a60a00a83bb7d599d2e028ac0c3573dc2b9ec0842590f1c2e59781c821da7 AS lint-base
