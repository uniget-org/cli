...
FROM ghcr.io/uniget-org/tools/gh:2.66.0@sha256:533c8b0e2696a15faf237357eb30497782dffb02cbbcc084a0695a0db5ed46dd AS uniget-gh
...
FROM golang:1.23.5@sha256:8c10f21bec412f08f73aa7b97ca5ac5f28a39d8a88030ad8a339fd0a781d72b4 AS latest-golang
...
FROM ghcr.io/uniget-org/images/systemd:ubuntu24.04@sha256:0a0d7ed63e51e5e69a2fc08280310e720e4b148ab8f791075ab5ff7c9575ec09 AS systemd-uniget
ARG version
ARG TARGETARCH
RUN <<EOF
case "${TARGETARCH}" in
