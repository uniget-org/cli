...
FROM ghcr.io/uniget-org/tools/syft:1.49.0@sha256:77dbf657836441a878789559d858fd178c9dd040cc0b463c86ed61b8a96b9461 AS uniget-syft
...
FROM ghcr.io/uniget-org/tools/glab:1.109.0@sha256:ea8160b135301eb56a881d74aba5618c86c6eff4a07287123071fe19138adb1e AS uniget-glab
...
FROM golang:1.26.5@sha256:3aff6657219a4d9c14e27fb1d8976c49c29fddb70ba835014f477e1c70636647 AS latest-golang
FROM alpine:3.24.1@sha256:28bd5fe8b56d1bd048e5babf5b10710ebe0bae67db86916198a6eec434943f8b AS latest-alpine
FROM ubuntu:26.04@sha256:3131b4cc82a783df6c9df078f86e01819a13594b865c2cad47bd1bca2b7063bb AS latest-ubuntu2404
...
FROM registry.gitlab.com/uniget-org/images/ubuntu:26.04@sha256:059b11407572b2fd733e7bcd1c528852394d7fe1abef7119a1a97356983cab76 AS noble-uniget
ARG version
