...
FROM ghcr.io/uniget-org/tools/glab:1.103.0@sha256:e49bf67c6da25c89ef19f578b80e7ad1389af4925c3da9dc94d45afd18a699e7 AS uniget-glab
...
FROM registry.gitlab.com/uniget-org/images/ubuntu:26.04@sha256:8fc1cc1ba5dd196bd42790880931d3d76985c2a94ec55e8095615331dfd3b580 AS noble-uniget
ARG version
...
FROM registry.gitlab.com/uniget-org/images/systemd:26.04@sha256:66e1caff55bf684169caf2d617d4b87150037cb01303f9b65b8a6e901ed36c29 AS systemd-uniget
ARG version
COPY --from=uniget-release /usr/local/bin/uniget /usr/local/bin/uniget
RUN <<EOF
useradd --shell=/bin/bash --create-home bob
