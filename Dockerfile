...
FROM ghcr.io/uniget-org/tools/golangci-lint:1.63.2@sha256:ece1676fd7dc1a7e17315b5b09f8fd4b203887ba6f90ef9943ce02a5a79f482c AS lint-base
...
FROM ghcr.io/uniget-org/images/systemd:ubuntu24.04@sha256:86251327549fcb035b60ab47691bd1a34b25fe64e283de39f063cc3534a4fb25 AS systemd-uniget
ARG version
ARG TARGETARCH
RUN <<EOF
case "${TARGETARCH}" in
