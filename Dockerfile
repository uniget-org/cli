...
FROM ghcr.io/uniget-org/tools/syft:1.18.0@sha256:bb6e5418ead2b72d52b824907c35ced2d2e79d19b388bd218048ce68dcbebf23 AS uniget-syft
...
FROM ghcr.io/uniget-org/images/systemd:ubuntu24.04@sha256:b37b15d5061f33608bb384e8558081caa2b983ba30bf1962ff45998e2380fa7b AS systemd-uniget
ARG version
ARG TARGETARCH
RUN <<EOF
case "${TARGETARCH}" in
